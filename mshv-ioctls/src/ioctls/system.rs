...
fn make_partition_create_arg(vm_type: VmType) -> mshv_create_partition_v2 {
    ...
    unsafe {
        ...
        disabled_xsave_features.__bindgen_anon_1.set_xsave_support(0u64);
        disabled_xsave_features.__bindgen_anon_1.set_xsaveopt_support(0u64);
        disabled_xsave_features.__bindgen_anon_1.set_avx_support(0u64);
        disabled_xsave_features
            .__bindgen_anon_1
            .set_xsave_supervisor_support(0u64);
        disabled_xsave_features.__bindgen_anon_1.set_xsave_comp_support(0u64);
        ...
        disabled_proc_features.__bindgen_anon_1.set_rd_rand_support(0u64);
        disabled_proc_features.__bindgen_anon_1.set_cet_ibt_support(0u64);
        disabled_proc_features.__bindgen_anon_1.set_cet_ss_support(0u64);
        disabled_proc_features.__bindgen_anon_1.set_smep_support(0u64);
        disabled_proc_features.__bindgen_anon_1.set_rdtscp_support(0u64);
    ...
    unsafe {
        ...
        disabled_proc_features.__bindgen_anon_1.set_pmu_v3(0u64);
    }
